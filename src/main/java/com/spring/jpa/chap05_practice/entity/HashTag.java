...
public class HashTag {
    ...
    @ManyToOne(fetch = FetchType.LAZY, cascade = CascadeType.ALL)  //내가 많고 post가 1이니, ManyToOne이다. 전략도 LAZY로딩으로해주자. cascade는 부모가 지워지면 자식도 지워짐. ALL말고 REMOVE해도됨. 귀찮으면 ALL. 제약조건을 이게 마음에 안들면, 근데 테이블에 직접 걸어도 된다.
